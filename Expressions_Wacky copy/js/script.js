...
var fruFour = prompt("I amm starting to question if you were the right animal for this task. Let uss hope your personal favorites did better. So, what fruit did the " + aniFour + " Platoon collect?");
...
var fruPerShot = 10;
var allFru = array[fruOneNum, fruTwoNum, fruThreeNum, fruFourNum];
var fruTotal = allfru[1] + allFru[2] + allFru[3] + allFru[4];
var fruRem = fruTotal%fruPerShot;
var canShots = (fruTotal - fruRem) / fruPerShot;
